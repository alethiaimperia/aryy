...
class NuevaUbicacionWidget extends StatefulWidget {
  ...
  @override
  _NuevaUbicacionWidgetState createState() => _NuevaUbicacionWidgetState();
}

class _NuevaUbicacionWidgetState extends State<NuevaUbicacionWidget> {
